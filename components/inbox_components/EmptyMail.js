      ...
      <div className="flex flex-col items-center justify-center h-full">
        <div className="mx-auto">
          ...
          >
            ...
            ></path>
            <path
              d="M768.3 336.5a.4.4 0 1 0 0-.8.4.4 0 0 0 0 .8Z"
              fill="#E6E8EC"
            ></path>
            <path
        ...
        <h1 className="dark:text-gray-300 text-gray-900 text-2xl tracking-tight leading-9 sm:text-lg sm:leading-10">
          Temp Mail
        </h1>
        <span className="text-center dark:text-gray-400 text-gray-600 lg:max-w-2xl">
          Protect your personal email address from spam, bots, phishing and
          other online abuse. Temporary anonymous email address - no commitments
          and no risks.
        </span>
      </div>
    </>
