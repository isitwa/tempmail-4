...
export default function MailBox_MailGroup() {
  return (
    <>
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-0 p-6 border border-gray-200 rounded-md justify-between items-center bg-white">
          <div className="grow flex items-center gap-3">
            <div className="bg-gray-100 w-[50px] h-[50px] overflow-hidden inline-block shrink-0">
              <Image src={mailIcon} width="100" height="100" alt="mail icon" />
            </div>
